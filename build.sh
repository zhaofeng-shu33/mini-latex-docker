...
tlmgr install listings IEEEtran wrapfig etoolbox translator caption mathtools algorithms float footmisc cite pdfescape elsarticle algorithmicx bbm-macros bbm dehyph-exptl epstopdf;
